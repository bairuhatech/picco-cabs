  ...
  <footer className="bg-light text-center text-md-left md-0 mt-5" id="footer">
    <Container className="text-center">
      ...
      <Row className="justify-content-center mx-2 py-3 text-start">
        <Col md={8}  lg={4} sm={6} xs={12} className="mx-auto pb-4 ">
          ...
          <Row>
            <Col md={6} sm={12}>
              <ul className="list-unstyled ">
                ...
                <li className={"pr-2 text-wrap"}>Ramanathapuram</li>
        ...
        <Col lg={3} md={4} sm={6} xs={12} className="mx-auto pb-4">
        ...
        <Col lg={2} md={6} sm={6} className="col-md-2 col-xs-6 mx-auto pb-4 ">
        ...
        <Col lg={3} md={6} sm={6} className="col-md-3 col-xs-6 mx-auto pb-4 ">
      ...
      <Row className="justify-content-center ">
                <Col lg={12} md={12} xs={12} className="mx-2 ">
                    {/* <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3930.2054855433!2d78.12485339814957!3d9.916837259505712!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5c0f79cd9a76f481!2sPicco%20cabs!5e0!3m2!1sen!2sin!4v1601530520424!5m2!1sen!2sin
                            " id="map " frameBorder="0 " width="100%" style={{border: "0", height: "250px"}}  aria-hidden="false " className="img-fluid " ></iframe> */}
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3930.2054855433!2d78.12485339814957!3d9.916837259505712!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5c0f79cd9a76f481!2sPicco%20cabs!5e0!3m2!1sen!2sin!4v1601530520424!5m2!1sen!2sin"
                            id="map " frameBorder="0 " width="100%" height="250px"></iframe>
                </Col>
            </Row>
