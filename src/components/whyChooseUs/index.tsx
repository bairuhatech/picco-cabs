      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="center-heading my-5">
            <h2 className="text-center mt-5" style={{ color: "#6BB546" }}>
              Why Choose Us?
            </h2>
          </div>
        </div>
      ...
      <div className="row mt-3 justify-content-center">
        <div className="col-lg-3 col-sm-6 col-xs-8 col-10">
          <a className="services-small-item">
            ...
            <h5 className="services-title my-5 text-decoration-none">
              Best Price
            </h5>
            <p style={{ height: "75px" }}>
              {" "}
              We reward you with lower rates the longer you rent a car from us
              and at best price.
            </p>
          </a>
        </div>
        <div className="col-lg-3 col-sm-6 col-xs-8 col-10">
          <a className="services-small-item">
            ...
            <p style={{ height: "75px" }}>
              {" "}
              An immediate free transfer service to your residence and
        ...
        <div className="col-lg-3 col-sm-6 col-xs-8 col-10">
          <a className="services-small-item">
            ...
            <p style={{ height: "75px" }}>
              Our friendly and knowledgeable drivers will take care of you with
        ...
        <div className="col-lg-3 col-sm-6 col-xs-8 col-10">
          <a className="services-small-item">
            ...
            <p style={{ height: "75px" }}>
              All our cars and brand new and regularly audited cars.
            </p>
          </a>
        </div>
      </div>
