...
export default function RoundTrip() {
  ...
  const time = currTime.getHours().toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false});
  const minute = currTime.getMinutes().toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false});;
    return (
      <div className="mt-3">
        <form action="">
