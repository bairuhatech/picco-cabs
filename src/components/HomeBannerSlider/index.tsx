...
import SB1 from "../../assets/images/p1.jpg";
import SB2 from "../../assets/images/p2.jpg";
import SB3 from "../../assets/images/p3.jpg";
import B1 from "../../assets/images/banner_desktop1.webp";
import B2 from "../../assets/images/banner_desktop2.webp";
import B3 from "../../assets/images/banner_desktop3.webp";
      ...
      <Slider {...carouselSettings}>
        {carouselItems.map((item) => (
          <div key={item.id} className="carouselItem">
            <img className="carouselImg" src={item.src} alt={item.alt} />
          </div>
        ))}
      </Slider>
    </div>
